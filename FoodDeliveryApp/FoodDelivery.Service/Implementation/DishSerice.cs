...
{
    public class DishSerice : IDishService
    {
        ...
        public DishSerice(IRepository<Dish> dishRepository, IUserRepository userRepository,IDishRepository dishRepository1, IRepository<DishInShoppingCart> dishInShoppingCartRepository)
        {
